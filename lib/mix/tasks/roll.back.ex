defmodule Mix.Tasks.Roll.Back do
  ...
  Migrations are expected at "priv/YOUR_REPO/roll" directory
  ...
  ## Examples
      mix roll.back
      mix roll.back -r Custom.Repo
      mix roll.back -n 3
      mix roll.back --step 3
      mix roll.back --to 20080906120000
  ## Command line options
    ...
    * `--migrations-path` - the path to load the migrations from, defaults to
      ...
      `mix roll.back --migrations-path a/`, only the latest migrations from `a/` will be
