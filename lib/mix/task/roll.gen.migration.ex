defmodule Mix.Tasks.Roll.Gen.Migration do
  ...
  "priv/YOUR_REPO/roll" directory of the current application
  ...
  ## Command line options
    ...
    * `--migrations-path` - the path to run the migrations from, defaults to `priv/repo/roll`
  ## Configuration
    ...
    Enum.map(repos, fn repo ->
      case OptionParser.parse!(args, strict: @switches, aliases: @aliases) do
        {opts, [name]} ->
          ...
          path = opts[:migrations_path] || Path.join(source_repo_priv(repo), "roll")
